...
- [ ] `sethyrung about` prints the bio on stdout and exits 0
- [ ] About is bio only — no education, certs, or Dev Card Tagline stand-in
- [ ] Unknown Screen name: stderr lists known Screens, exit 1, no Screen on stdout
- [ ] `sethyrung about extra` fails the same way as an unknown Screen
